...
#warning 修改了此处--将return size.width + 15 换为 return self.menuItemWidth 即恢复原状
    CGSize size = [_titles[index] boundingRectWithSize:CGSizeMake(100, 0) options:NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin |  NSStringDrawingUsesFontLeading attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:WMTitleSizeSelected]} context:nil].size;
